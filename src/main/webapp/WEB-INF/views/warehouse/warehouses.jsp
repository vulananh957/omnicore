    ...
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        ...
        <div class="action-bar">
            <div class="search-input-wrap">
                ...
                <input class="search-input" type="text" id="warehouseSearch"
        ...
        <div class="table-card">
            <div class="table-responsive">
                <table class="wms-table">
                    <thead>
                        <!-- parse json và dựng các dòng tr hiển thị trên bảng  -->
                        <tr>
                ...
                <div class="modal-body">
                    ...
                    <div class="section-title-row">
                        ...
                        <div class="status-toggle-container">
                            ...
                            <button type="button" class="btn-switch active" id="btnSwitchStatus"
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-input" id="whAddress" rows="2"
                            placeholder="VD: 123 Nguyễn Huệ, Phường Bến Nghé, Quận 1, TP.HCM"></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="section-desc">
                            Theo quy chuẩn vận hành hệ thống WMS, chi nhánh kho mới khởi tạo sẽ tự động được gán các
                            phân khu tiêu chuẩn để phục vụ đúng luồng các Use Cases (nhập hàng mới, hoàn trả, khiếu
                            nại).
                        </p>
                    </div>
                    ...
                    <div class="modal-checklist">
                        ...
                        <label class="checklist-item">
                            ...
                            <div class="checklist-info">
                                ...
                                <p class="checklist-desc">Chứa hàng hóa đạt tiêu chuẩn chất lượng, sẵn sàng phục vụ xuất
                                    kho bán hàng.</p>
                            </div>
                        </label>
                        ...
                        <!-- Defect Zone -->
                        <label class="checklist-item"
                            style="border-top: 1px solid rgba(229, 234, 243, 0.6); padding-top: 10px;">
                            ...
                            <div class="checklist-info">
                                ...
                                <p class="checklist-desc">Lưu trữ hàng hóa bị hư hỏng, lỗi ngoại quan chờ phê duyệt
                                    thanh lý hủy bỏ.</p>
                            </div>
                        </label>
                        ...
                        <label class="checklist-item"
                            ...
                            <div class="checklist-info">
                                ...
                                <p class="checklist-desc">Phục vụ cách ly kiện hàng bị khách trả về, chờ nhân viên QC
                    ...
                    <div class="sync-card">
                        ...
                        <div>
                            ...
                            Khi bạn nhấn lưu kho, hệ thống sẽ thực hiện đồng thời: khởi tạo 1 bản ghi
                            <code>location</code> mới và tự động chèn liên kết khóa ngoại <code>location_id</code> vào
                            bảng <code>zone</code>.
                        </div>
                    </div>
                </div>
        ...
        <script>
            ...
            (function () {
                ...
                function saveForm() {
                    ...
                    // đóng gói thông tin kho, thông tin các zones thành 1 payload json duy nhất
                    var payload = {
                        id: editingWarehouseId ? parseInt(editingWarehouseId) : 0, // 0 là thêm mới, >0 là cập nhật
                        code: codeVal,
                        name: nameVal,
                        address: addressVal,
                    ...
                    fetch(window.location.pathname + '?action=save', { // gửi fetch post tới servlet
                        method: 'POST',
                        headers: {
                        ...
                        .then(function (resData) {
                            if (resData.success) {
                                closeModal();
                                fetchWarehouses(); // tự động gọi hàm js ngay khi tải trang
                            } else {
                ...
                // hàm được chạy khi tải lại trang
