<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        <%-- BusinessDashboard body — injected into dashboard-layout.jsp via jsp:include Mirrors React
            BusinessDashboard.tsx pixel-perfect --%>

            <!-- ══ PERIOD FILTER BAR ══════════════════════════════════════ -->
            <div class="filter-bar">
                <div class="period-tabs" id="periodTabs">
                    <!-- bộ nút bấm chọn khung thời gian, 
         khi đổi thì js trên trang sẽ redirect về business/dashboard?period=7ngay
         servlet sẽ chạy lại từ đầu với bộ lọc mới -->
                    <button class="period-tab ${period == '7ngay' ? 'active' : ''}" data-period="7ngay">7 ngày</button>
                    <button class="period-tab ${period == '30ngay' || period == null || period == '' ? 'active' : ''}"
                        data-period="30ngay">30 ngày</button>
                    <button class="period-tab ${period == '3thang' ? 'active' : ''}" data-period="3thang">3
                        tháng</button>
                    <button class="period-tab ${period == '6thang' ? 'active' : ''}" data-period="6thang">6
                        tháng</button>
            ...
            <div class="two-col-grid">
                ...
                <div class="panel">
                    ...
                    <div style="display:flex;justify-content:center;margin:16px 0;position:relative;" id="pieWrap">
                        <svg id="pieChart" width="280" height="280" viewBox="0 0 280 280"
                            style="overflow:visible"></svg>
                        <div class="chart-tooltip" id="pieTooltip"
                            style="display:none;position:absolute;top:-8px;left:50%;transform:translate(-50%,-100%)">
                        </div>
                    </div>
                ...
                <div class="panel">
                    ...
                    <div style="display:flex;justify-content:center;align-items:center;min-height:260px;position:relative;margin:8px 0;"
                        id="donutWrap">
                        <svg id="donutChart" width="214" height="214" viewBox="0 0 214 214"
                            style="overflow:visible"></svg>
                ...
                (function () {
                    ...
                    if (btnViewAll) {
                        btnViewAll.addEventListener('click', function () {
                            window.location.href = '${pageContext.request.contextPath}/business/performance';
                        });
                    }
